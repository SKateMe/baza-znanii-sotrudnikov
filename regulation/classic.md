...
1. Администратор при разборках обязан вызвать жертву и нарушителя. Если наличие пострадавшего не предусмотрено ситуацией, соответственно, вызывать и некого
...
Если у игрока появляются вопросы насчёт игры или правил, то администратор обязан ответить в админ. башне за класс обучение
...
2. Если SCP покидает игру, администратор имеет право поставить себя на его роль, но не более чем один раз в пять раундов
3. Администратор обязан уведомить через Broadcasting игроков о том, что SCP был восстановлен по причинам, перечисленным в пункте A5
{% endhint %}
...
Администратор должен быть сдержанным, иметь стальную волю, а также не поддаваться ни на единую провокацию
...
### А11.1. Администратору запрещено спавнить игрока за класс обучение для разборок
...
1. Игрок находится в наблюдателях, то есть не находится в игровом процессе
...
Администратору запрещено находиться на сервере со скрытым тегом
